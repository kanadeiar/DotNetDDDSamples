...
namespace ESCQRS.Inventory.Core.Tests.Unit.InventoryAggregate;
...
public class InventoryItemTests
{
    ...
    public void TestCreate(string name, int quantity)
    {
        ...
        var actual = InventoryItem.Create(id, new InventoryNameValue(name), new QuantityValue(quantity));
    ...
    public void TestCreateNewQuestionnaire_WhenInvariantError(string name, int quantity)
    {
        var act = () =>
        {
            _ = InventoryItem.Create(InventoryId.New, new InventoryNameValue(name), new QuantityValue(quantity));
        };
